...
public enum Tipo {
	...
	private static final double[][] MULTIPLICADORES_AAD = { {NULO,NO_EFICAZ,EFICAZ,NO_EFICAZ,NEUTRO,NEUTRO,EFICAZ,NEUTRO,NEUTRO,NEUTRO,NEUTRO,NEUTRO,NEUTRO,EFICAZ}, // FUEGO
