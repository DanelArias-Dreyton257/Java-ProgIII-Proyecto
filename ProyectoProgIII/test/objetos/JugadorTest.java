...
public class JugadorTest {
	...
	Tipo[] tipitos= {Tipo.FUEGO,Tipo.AGUA};
	 ...
	 Leyenda l2= new Leyenda("Zeus", "Dios del rayo", tipitos, nada, 43, 32, 45, 123);
	 Leyenda l3= new Leyenda("Zeus", "Dios del rayo", tipitos, nada, 13, 32, 56, 123);
	 Leyenda l4= new Leyenda("Zeus", "Dios del rayo", tipitos, nada, 22, 32, 67, 123);
	 Leyenda l5= new Leyenda("Zeus", "Dios del rayo", tipitos, nada, 33, 32, 34, 123);
	 Leyenda l6= new Leyenda("Zeus", "Dios del rayo", tipitos, nada, 44, 32, 22, 123);
	 int Numero=6;
	 public void setUp() {
	...
	public void test() {
		...
		assertEquals(l3, j1.getLeyendaEternidad(3));
	}
